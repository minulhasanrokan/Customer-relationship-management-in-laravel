                ...
                <div class="card">
                    <div class="card-body">
                        <div class="basic-form">
                            <h2>Input Designation Information</h2>
                            ...
                            @endif
                            <form method="POST" action="{{url('submit-designation')}}" enctype="multipart/form-data" style="color:black;">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        <button type="submit" style="margin-top:15px; margin-bottom: 15px; padding-right: 25px; padding-left: 25px; float: right;" type="button" class="btn btn-primary">Add New Department</button>
                                    </div>
                                </div>
                            </form>
                        </div>
